...
def init_predictor(args):
    ...
    # pass_builder.set_passes(["quant_linear_fuse_pass"])
...
def parse_args():
    ...
    parser.add_argument(
        "--model_file",
        type=str,
        default="../output_ptq/int8_infer.pdmodel",
        help="Model filename, Specify this when your model is a combined model.",
    )
    parser.add_argument(
        "--params_file",
        type=str,
        default="../output_ptq/int8_infer.pdiparams",
...
if __name__ == "__main__":
    ...
    img = cv2.imread("./ILSVRC2012_val_00000100.JPEG")
    img = preprocess(img)
